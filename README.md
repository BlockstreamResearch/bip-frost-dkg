...
def detpedpop_round2(seed, params, round1s):
    ...
    return secpedpop_round2(seed_, t, enckeys)
```
...
def detpedpop_finalize(seed, hostverkeys, vss_commits, enc_shares):
    ...
    return secpedpop_finalize(enckeys, my_enckey, vss_commits, enc_shares, certifying_Eq(my_hostsigkey, hostverkeys), setup_id)
```
